## What is this?
This repository is meant to serve as bare-bones example of a NestJS application
for folks to reference when they are getting started with NestJS. The goal is to
